...
if __name__ == '__main__':
    ...
    # foOne = one.reshape(-1, 1).T
    # point_2d_one = project_points_into_low_space(foOne)
    # reconstr_one = project_points_into_orginal_space(point_2d_one)
    # plot_image(reconstr_one)
    # plt.show()
    ...
    # fo_three = data[1].reshape(-1, 1).T
    # point_2d_three = project_points_into_low_space(fo_three)
    # reconstr_three = project_points_into_orginal_space(point_2d_three)
    # plot_image(reconstr_three)
    # plt.show()

    # Case 2b:
    # pcs, points_2d = calculate_pca(data)
    # print(pcs)
    # plot_interactive(points_2d, data)
    # plt.show()
